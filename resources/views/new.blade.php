...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+HK:wght@400;500;700;900&display=swap"
        rel="stylesheet">
    ...
    <section id="work-section">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-3 ">
                <div class="col mb-4">
                    <div class="card">
                        <img style="width:339px; height:225px;" src="./images/3.png" class="card-img-top"
                            alt="Project Image">
                        <div class="card-body">
                            <h2 class="card-title">YelpCamp</h5>
                                ...
                                <p class="card-text">Yelpcamp is a campground rating app, where users can create their
                                    own campgrounds, view and comment on others' campgrounds.</p>
                        </div>
                    </div>
                </div>
                <div class="col mb-4">
                    <div class="card">
                        <img style="width:339px; height:225px;" src="./images/2.png" class="card-img-top"
                            alt="Project Image">
                        <div class="card-body">
                ...
                <div class="col mb-4">
                    <div class="card">
                        <img style="width:339px; height:225px;" src="./images/4.png" class="card-img-top"
                            alt="Project Image">
                        <div class="card-body">
                            <h2 class="card-title">Laravel CRUD</h5>
                                <p class="text-uppercase">HTML/CSS/JS PHP Laravel</p>
                                <p class="card-text">CRUD stands for Create, Read, Update and Delete which are
                                    operations needed in most data-driven apps that access and work with data from a
                                    database.</p>
                        </div>
                    </div>
                </div>
                <div class="col mb-4">
                    <div class="card">
                        <img style="width:339px; height:225px;" src="./images/1.png" class="card-img-top"
                            alt="Project Image">
                        <div class="card-body">
                            <h2 class="card-title">Todolist</h5>
                                <p class="text-uppercase"> HTML/CSS/JS</p>
                                <p class="card-text">TThis one is a super simple to-do list where you can cross out what
                ...
                <div class="col mb-4">
                    <div class="card">
                        <img style="width:339px; height:225px;" src="./images/dotexpress.png" class="card-img-top"
                            alt="Project Image">
                        <div class="card-body">
                ...
                <div class="col mb-4">
                    <div class="card">
                        <img style="width:339px; height:225px;" src="./images/organo.png" class="card-img-top"
                            alt="Project Image">
                        <div class="card-body">
                            <h2 class="card-title">Bender, destroy the universe!</h5>
                                <p class="text-uppercase">Webflow</p>
                                <p class="card-text">This is a Color Game made purely with vanilla JS. There will be an
                                    rgb value,You have to correctly guess which square it is by the rgb value.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="about-columns">
                <div class="left-column">
                    ...
                    <div class="about-para">
                        <h3>A full-stack web developer and user interface designer with a background in Mathematics,
                            Statistics and Computer Science. Currently employed in Hyderabad, looking for my next
                            professional opportunity in my field</h3>
                    </div>
                    ...
                    <div class="capabilities">
                        ...
                        <div>
                            <p class="about-point">Front-end web development: HTML, CSS, and Javascript Fundamentals,
                                Vue.js, jQuery, Bootstrap (UI) </p>
                            <p class="about-point">Back-end web development: PHP - Laravel framework, MySQL/MongoDB
                                Databases</p>
                            ...
                            <p class="about-point">Package managers, builders - Node Package Manager, Composer, Webpack
                            </p>
