  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item-active">
      ...
      <div class="carousel-caption">
        <p class="heading" style="text-transform:uppercase" class="h3-responsive">ORGANO</p>
        <p class="desc">Bender, quit destroying the universe! That could be 'my' beautiful soul sitting naked on a couch. If I could just learn to play this stupid thing. </p>
        <button class="btn btn-small"><a href="">VISIT SITE</a></button>
      </div>
    </div>
